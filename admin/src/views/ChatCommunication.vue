<template>
  <div class="chat-communication">
    <div class="page-header">
      ...
      <p class="page-desc">总管理后台与用户相互聊天沟通</p>
    </div>
    ...
    <el-row :gutter="20">
      ...
      <!-- 中间: 聊天界面 -->
      <el-col :xs="24" :md="10" v-if="currentChatUser">
        <el-card class="chat-card">
          ...
          <div class="chat-messages" ref="messagesContainer">
            <div
              ...
              :key="message.id"
              class="message-item"
              :class="message.senderId === currentAdminId ? 'message-right' : 'message-left'"
            >
              <el-avatar
                :size="40"
                :src="message.senderId === currentAdminId ? currentAdminAvatar : currentChatUser.avatar"
                class="message-avatar"
              />
              <div class="message-content">
                <div class="message-info">
                  <span class="sender-name">
                    {{ message.senderId === currentAdminId ? '我' : currentChatUser.nickname }}
                  </span>
      ...
      <!-- 右侧: 用户详情 -->
      <el-col :xs="24" :md="6" v-if="currentChatUser">
        <el-card class="user-detail-card">
          ...
          <div class="user-detail-content">
            <div class="detail-avatar">
              <el-avatar :size="80" :src="currentChatUser.avatar" />
              <el-tag v-if="currentChatUser.online" type="success" class="online-tag">在线</el-tag>
            </div>
            <div class="detail-info">
              <div class="detail-item">
                <span class="label">昵称:</span>
                <span class="value">{{ currentChatUser.nickname }}</span>
              </div>
              <div class="detail-item">
                <span class="label">性别:</span>
                <span class="value">{{ currentChatUser.gender }}</span>
              </div>
              <div class="detail-item">
                <span class="label">年龄:</span>
                <span class="value">{{ currentChatUser.age }}岁</span>
              </div>
              <div class="detail-item">
                <span class="label">残疾类型:</span>
                <span class="value">{{ currentChatUser.disabilityType }}</span>
              </div>
              <div class="detail-item">
                <span class="label">残疾等级:</span>
                <span class="value">{{ currentChatUser.disabilityLevel }}级</span>
              </div>
              <div class="detail-item">
                <span class="label">所在地区:</span>
                <span class="value">{{ currentChatUser.region }}</span>
              </div>
              <div class="detail-item">
                <span class="label">注册时间:</span>
                <span class="value">{{ currentChatUser.createdAt }}</span>
              </div>
            </div>

            <div class="quick-actions">
              <el-button type="primary" @click="handleViewProfile" style="width: 100%">
                查看完整资料
              </el-button>
              <el-button @click="handleReassign" style="width: 100%; margin-top: 10px;">
                重新分配红娘
              </el-button>
            </div>
          </div>
...
const currentAdminAvatar = ref('https://api.dicebear.com/7.x/avataaars/svg?seed=admin')
